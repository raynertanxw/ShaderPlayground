Shader "_Custom/CGCookie Tutorials/Intermediate/7 - Flat Translucency"{
	Properties {
		...
		_AdditionalDotTolerence ("Additional Dot Tolerence", Range(0.0, 1.0)) = 0.0
	}
	SubShader {
		Pass {
			...
			uniform fixed _AdditionalDotTolerence;
			...
			fixed4 frag(vertexOutput i) : COLOR
			{
				//Lighting
				//dot product
				fixed nDotL = saturate((dot(i.normalDir, i.lightDir.xyz) + _AdditionalDotTolerence) * (1.0f/(1.0f + _AdditionalDotTolerence)));
