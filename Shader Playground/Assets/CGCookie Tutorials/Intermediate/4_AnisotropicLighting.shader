Shader "_Custom/CGCookie Tutorials/Intermediate/4 - Anisotropic Lighting" {
	...
	SubShader {
		Pass {
			...
			fixed4 frag(vertexOutput i) : COLOR
			{
				...
				// Specular
				fixed3 specularReflection = diffuseReflection * _SpecColor.xyz * exp( -(tDotHX * tDotHX + bDotHY * bDotHY) ) * _Shiniess;
